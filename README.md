...
In this fork i focus on the usage and installation on [Symfony 7](https://symfony.com/doc/7.0/setup.html).

> :warning: __Note__: This fork doesn't support a Symfony version prior to 6.0.
...
We will use this [FormType](https://symfony.com/doc/current/reference/forms/types.html):
